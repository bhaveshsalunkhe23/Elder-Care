...
class staffmemberUserForm(forms.ModelForm):
    class Meta:
        model=User
        fields=['first_name','last_name','username','password']
        widgets = {
...
class staffmemberSalaryForm(forms.Form):
...
class RequestForm(forms.ModelForm):
    class Meta:
        ...
        fields=['category','member_no','member_name','member_model','member_brand','problem_description']
        widgets = {
...
class AdminRequestForm(forms.Form):
    ...
    staffmember=forms.ModelChoiceField(queryset=models.staffmember.objects.all(),empty_label="staffmember Name",to_field_name='id')
...
class staffmemberUpdateStatusForm(forms.Form):
